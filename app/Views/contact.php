...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Contact Us - Sha Pick Collection</title>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contact-info">
                            <h2>Our Store</h2>
                            <h3><i class="fa fa-map-marker"></i>Sitio Mahogany Leuteboro 2, Socorro Oriental Mindoro,Philippines</h3>
                            <h3><i class="fa fa-envelope"></i>shainamariesamarita14@gmail.com</h3>
                            <h3><i class="fa fa-phone"></i> 0905 474 2754</h3>
                            <div class="social">
                    ...
                    <div class="col-lg-6">
                        <div class="contact-form">
                            ...
                            <form action="<?= base_url('contact')?>" method ="POST" autocomplete="off" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="form-group">
                                    <textarea name="message" id="message" class="form-control <?= ($validation->getError('message'))?'is-invalid':''?>" rows="5" placeholder="Message"></textarea>
                                    <?php if($validation->getError('message')): ?>
                                        <div class="invalid-feedback"><?= $validation->getError('message') ?></div>
                                    <?php endif;?>
                                </div>
                                <div class="form-group">
                                    <input type="file" name="file" id="file" class="form-control <?= ($validation->getError('file'))?'is-invalid':''?>" placeholder="Upload file" />
                    ...
                    <div class="col-lg-12">
                        <div class="contact-map">
                            <iframe src="https://maps.google.com/maps?q=masipit%20calapan&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                        </div>
                    </div>
                </div>
            </div>
